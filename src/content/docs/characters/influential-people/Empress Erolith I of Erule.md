---
title: Empress Erolith I of Erule
description: Empress of Erule
type: character
tier: influential
role: npc
status: active
...
|---|---|
|**Full Name**|Empress Erolith I Aquabrand|
...
![Erulian Race](/Images/people/Erolith.png)
...
Empress Erolith is a woman of divided natures, shaped as much by the throne as by the solitude it demands.
...
As Empress of the Erulian Empire, Erolith commands the single greatest concentration of power on Omain. From Erule—jewel of Droskarin and heart of the Empire—her authority radiates across continents, seas, faiths, and economies.

### Imperial Territories & Natural Resources

The Erulian Empire controls vast and diverse regions of Droskarin as well as multiple overseas holdings and protectorates. Under Erolith’s rule, these lands are not merely governed—they are systematized.
...
Erolith presides over the most advanced and centralized economy ever recorded.
...
Erolith is Supreme Commander of the Imperial War Structure.

Her forces include:

- The **Imperial Legions** (professional standing armies)
    
- **Colonial and provincial hosts**
    
- **Naval armadas** guarding both trade and war seas
    
- **Elementally trained divisions**
    
- **Siege foundries and war-academies**
...
Erolith’s court is the political axis of the known world.
...
As a devout ruler baptized under Tiamat and openly bound to the Hexadem, Erolith exerts enormous influence over faith.
...
The Empire maintains vast census networks, historical archives, bloodline registries, relic catalogues, prophetic records, and cartographic institutes. Scholars, engineers, priests, and strategists are trained under imperial sponsorship.
...
Erolith’s foremost goal is the continued **stability and unification of Omain under Erulian order**. She believes that fractured rule inevitably leads to divine imbalance, wars of ignorance, and the rise of forces that mortals are not meant to challenge.
...
Her devotion to the Hexadem is not ceremonial—it is foundational. Erolith believes the gods act through civilization, and that empires are the vessels through which divine will is stabilized.
...
The Siege of Erule defines her reign.
...
Erolith believes ignorance is as dangerous as any demon or tyrant. She aims to transform the Empire into the greatest center of knowledge in existence.

She pushes for:

- imperial universities and research enclaves
    
- theological and arcane integration
    
- state-funded invention and innovation
    
- preservation of ancient records and pre-restoration history
...
Though she rarely speaks of it, Erolith is acutely aware that empires fall through succession.
...
On a more personal level, Erolith seeks **direct guidance from Tiamat**.
...
Above all, Erolith’s ultimate goal is simple in concept and impossible in execution:
