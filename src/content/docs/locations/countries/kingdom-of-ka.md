...
![Flag of Ka](../../../../assets/images/ka/ka-flag.png)
(_Flag of Ka_)
...
_Not all council members support reinstating the monarchy; political division is increasing._
...
Thus, _heresy, blasphemy, and apostasy have no legal standing_.
...
| **Execution**       | _Last resort_, only for extreme treason or serial murder.   |
...
| Aspect           | Kingdom of Ka        | Erulian Empire             |
| ---------------- | -------------------- | -------------------------- |
...
| -------------------------- | ------------------------------------------------------------------ | ------------------- |
| **Monarch** _(or Council)_ | Supreme commander of all military forces                           | Head of state       |
...
| Type of Vessel                     | Approx. Count | Purpose                                    |
| ---------------------------------- | ------------- | ------------------------------------------ |
...
Unlike the army, the Kaian navy _does_ employ formal ranking due to coordination demands.
